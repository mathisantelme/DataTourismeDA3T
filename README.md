...
On pourra s'assurer de l'importation correcte des données en nous connectant à la base de données `mongo --host 127.0.0.1:27017` et en entrant les commandes suivantes qui vont permettre de nous connecter et d'afficher les données présentes dans la collection:

```nosql
use dataTourismDA3T;
db.enriched_traces.find().pretty();
```
